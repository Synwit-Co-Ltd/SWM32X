 ...
 * @param color_p pointer to an array of colors color_p指针指向一个颜色数组
 */
...
/**
 * Put a color map to a rectangular area on the active display 将彩色图片放置到活动显示的矩形区域
 * @param x1 left coordinate of the rectangle
 * @param x2 right coordinate of the rectangle
 * @param y1 top coordinate of the rectangle
 * @param y2 bottom coordinate of the rectangle
 * @param color_map pointer to an array of colors指针指向一个颜色数组
 */
