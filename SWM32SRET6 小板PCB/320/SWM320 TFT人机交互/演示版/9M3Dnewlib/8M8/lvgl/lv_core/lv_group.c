...
/**
 * Get the focused object or NULL if there isn't one 获取焦点对象 如果没有则为空
 * @param group pointer to a group 指向一个组的指针 （通常为所需change/copy的量）
 * @return pointer to the focused object 返回指向被聚焦对象的指针 
 */
