...
/**
 * Return with head node of the linked list 返回链表的head节点
 * @param ll_p pointer to linked list 指向链表的ll_p指针
 * @return pointer to the head of 'll_p' 返回指向'll_p'头部的指针
 */
...
/**
 * Return with tail node of the linked list 返回链表的尾节点
 * @param ll_p pointer to linked list 指向链表的ll_p指针
 * @return pointer to the head of 'll_p' 返回指向'll_p头部的指针
 */
...
/**
 * Return with the pointer of the next node after 'n_act'  在“n_act”之后返回下一个节点的指针
 * @param ll_p pointer to linked list 指向链表的ll_p指针
 * @param n_act pointer a node n_act指向一个节点
 * @return pointer to the next node  返回指向下一个节点的指针
 */
