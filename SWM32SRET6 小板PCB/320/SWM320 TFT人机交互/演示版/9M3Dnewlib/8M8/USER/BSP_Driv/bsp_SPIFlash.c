...
void SPI_Flash_Init(void)
{
	...
	GPIO_Init(GPIOP, PIN18,  1, 0, 0);				// 输出，接CS
	
	PORT_Init(PORTP, PIN19, FUNMUX1_SPI0_SCLK, 0);
	PORT_Init(PORTP, PIN22, FUNMUX0_SPI0_MOSI, 0);
	PORT_Init(PORTP, PIN23, FUNMUX1_SPI0_MISO, 1);
